...
| SPEC-004 | SPEC-004 五类分析能力域与 Analysis Card Schema v0.2.7.md | v0.2.7 | Review | 设计 | Analysis Card schema、domain_status 枚举、stance 枚举、constraint_exports 契约（含 registration_status）、五域能力定义 | ✅ `executable_specs/spec004/` |
...
| SPEC-010 | SPEC-010 MVP 范围与验证指标 v0.1.md | v0.1 | Draft | 需求 | MVP 范围宪法、验证标准、交付清单、exclusion 列表 | — |
...
| SPEC-016 | SPEC-016 Event Driven 域实现规格 v0.1.0.md | v0.1.0 | Draft | 实现 | Event Driven Pipeline（事件发现 / 预期差判断 / 可交易性评分 / 受益链条映射）、runtime score payload-only、PIT/as_of 防泄漏 | — |
